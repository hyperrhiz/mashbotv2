...
def generate_post():
    with open('lovers_full.txt') as f:
        text = f.read()

    text_model = markovify.Text(text, state_size=2)
    tweet_text = text_model.make_short_sentence(129) # was 140
    wrapped_text = textwrap.fill(tweet_text, 32)
    output_text = "@acoluthon " + tweet_text
